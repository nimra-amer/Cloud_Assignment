resource vnet1 'Microsoft.Network/virtualNetworks@2022-07-01' = {
  ...
  properties: {
    ...
    subnets: [
      { name: 'infra'; properties: { addressPrefix: '10.0.1.0/24' } }
      { name: 'storage'; properties: { addressPrefix: '10.0.2.0/24' } }
    ]
  }
}
...
resource vnet2 'Microsoft.Network/virtualNetworks@2022-07-01' = {
  ...
  properties: {
    ...
    subnets: [
      { name: 'infra'; properties: { addressPrefix: '10.1.1.0/24' } }
      { name: 'storage'; properties: { addressPrefix: '10.1.2.0/24' } }
    ]
  }
}
